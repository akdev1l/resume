...
\begin{aside}
  ...
  \section{Programming Languages}
    \item[\rightarrow] Java
    \item[\rightarrow] C
    \item[\rightarrow] C++
    \item[\rightarrow] Python
    \item[\rightarrow] Typescript
  \section{Projects}
    \item[\rightarrow]Proactive Shipment Detection System: Mitigated issues with customer shipments, preventing potential disruptions before impacting customers.
    \item[\rightarrow]Inventory Adjustment System: Automated large-scale inventory adjustments, improving accuracy and efficiency in responding to safety-critical events.
    \item[\rightarrow]Runtime Instrumentation for Java Applications: Enhanced infrastructure visibility, enabling better decision-making during critical region migrations.
\end{aside}
...
\begin{entrylist}
  \entry
    ...
    {Amazon}
    {\begin{itemize}
        \item Developed and owns a proactive shipment issue detection system, unblocking \~10M shipments/week and saving \~\$100M annually
        \item Spearheading critical migration efforts to meet the expected deadlines and avoiding costly delays due to infrastructure costs.
        \item Owns and maintains warehouse-facing tools processing thousands of requests from Amazon Warehouses globally.
        \item Provides high severity support for critical services, documenting and preparing communications to senior leadership.
        \item Performs technical deep dives to root cause and reproduce complex production issues.
        \item Finds new opportunities to deploy AI solutions to increase developer productivity.
    \end{itemize}}
  \entry
    ...
    {\begin{itemize}
        ...
        \item Led architecture design and execution, mentoring junior engineers through implementation and delivery of a platform processing 5k requests/week.
...
\begin{aside}
  ...
  \section{Human Languages}
    ...
    \item[\rightarrow]English (Fluent, C2)
  \section{Open Source Contributions}
    \item[\rightarrow]\href{https://github.com/neovim/neovim/issues/6575}{neovim}: Enabled building of statically linked binaries.
    \item[\rightarrow]\href{https://github.com/ublue-os/main}{Universal Blue}: Developed proof of concept containerizing the nvidia drivers into an OSTree-compatible OCI image.
